      ...
      try {
        ...
        savedStoriesList.innerHTML = savedStories
          .map((story) => {
            ...
            return `
              <article class="saved-story-item" data-id="${story.noteId}">
                <img src="${story.photoUrl}" alt="Foto story oleh ${story.title}" loading="lazy" />
                ...
                <div class="story-actions">
                  <button class="delete-saved-btn" data-id="${story.noteId}" style="background: #dc2626; color: white; border: none; padding: 6px 10px; border-radius: 4px; cursor: pointer; font-size: 0.8rem;">
